...
add_action( 'tgmpa_register', 'duck_register_required_plugins' );
/**
 ...
 */
function duck_register_required_plugins() {
	...
	$plugins = array(
		array(
			...
			'source'             => 'https://github.com/DuckDivers/duck-cherry-plugin/archive/master.zip',
		...
		array(
			...
			'source'	=> 'https://github.com/DuckDivers/quacky-shortcodes/archive/master.zip',
			'required'  => true, // If false, the plugin is only 'recommended' instead of required.
